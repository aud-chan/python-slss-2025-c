...
lowest_index = 1
current_number = 55
"current_number is not lower than 43, move on to the next number"
...
"current number is lower than 43! set the lowest_number to 1 and the lowest_index to 3"

new values:
lowest_number = 1
lowest_index = 3

Third and Fourth Comparison:
 --   *   2   S   %%   5
[-11, 43, 55, 1, 100, 34]

lowest_number = 1
lowest_index = 3
current_number = 100... current_number = 34

"100 is not lower than 34"
